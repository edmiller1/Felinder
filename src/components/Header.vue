<template>
  <header>
    <div id="banner" class="px-4 py-3">
      <div class="flex px-4 py-3 justify-between items-center">
        <div class="flex items-center">
          <svg
            class="fill-current text-white w-8 h-8"
            aria-hidden="true"
            data-prefix="fas"
            data-icon="cat"
          ...
          <span class="px-3 text-white text-xl font-semibold">Felinder</span>
        </div>
...
#border {
  border-bottom: 0.25rem solid #fd297b;
}
</style>